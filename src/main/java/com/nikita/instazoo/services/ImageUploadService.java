package com.nikita.instazoo.services;

import com.nikita.instazoo.repository.PostRepository;
import com.nikita.instazoo.entity.ImageModel;
import com.nikita.instazoo.entity.Post;
import com.nikita.instazoo.entity.User;
import com.nikita.instazoo.exceptions.ImageNotFoundException;
import com.nikita.instazoo.repository.ImageRepository;
import com.nikita.instazoo.repository.UserRepository;
...
public class ImageUploadService {
    ...
    public ImageModel uploadImageToUser(MultipartFile file, Principal principal)
        ...
        log.info("Uploading image to profile User {}", user.getUsername());
    ...
    public <T> Collector<T, ?, T> toSinglePostCollectors() {
